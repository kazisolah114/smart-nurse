...
const DashboardPage = () => {
    ...
    return (
        <>
            {/* Updates */}
            <section className='bg-gradient-to-r from-teal-500 to-emerald-500 p-4 rounded-md'>
                <div className='sm:flex items-center justify-between '>
                    ...
                    <div className='flex items-center gap-2 max-sm:mt-3'>
                        <Button variant="ghost" className="rounded-sm cursor-pointer text-white bg-emerald-600 hover:bg-emerald-700 hover:text-white"><Calendar className='w-5 h-5' /> Today</Button>
                        <Button variant="ghost" className="rounded-sm cursor-pointer text-white bg-emerald-600 hover:bg-emerald-700 hover:text-white"><MessageCircle className='w-5 h-5' /> New Message</Button>
                    </div>
                </div>
                <div className='updates mt-8'>
                    <ul className='grid grid-cols-4 max-sm:grid-cols-1 gap-5'>
                        {
                            updates.map((update, index) => {
                                return (
                                    <li key={index} className='bg-white/20 p-3 rounded-md flex flex-col'>
                                        <div className='flex items-center justify-between text-white mb-7 max-sm:mb-5'>
                                            <p className='font-medium text-[15px]'>{update.title}</p>
                                            <p className="font-semibold text-lg">{update.update}</p>
                                        </div>
                                        <div className='flex items-center gap-2 mt-auto text-slate-100 text-sm'>{update.icon} {update.latest}</div>
                                    </li>
                                )
                            })
                        }
            ...
            <section className="grid grid-cols-1 md:grid-cols-12 gap-4 mt-10">
                ...
                <div className="bg-white border p-4 col-span-12 md:col-span-8 rounded-md">
                    ...
                    <div className='mt-5 grid grid-cols-2 max-sm:grid-cols-1 gap-3'>
                        <div className='bg-blue-600/15 p-4  rounded-md flex items-center gap-4'>
                            ...
                            <div className=''>
                                ...
                                <h5 className='font-bold text-2xl max-sm:text-xl text-gray-800'>2</h5>
                            </div>
                        </div>
                        <div className='bg-green-600/15 p-4  rounded-md flex items-center gap-4'>
                            ...
                            <div className=''>
                                ...
                                <h5 className='font-bold text-2xl max-sm:text-xl text-gray-800'>8</h5>
                            </div>
                        </div>
                    </div>
                    <div className='mt-5'>
